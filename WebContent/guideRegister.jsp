...
<!-- faq.css -->
<link href="./css/guide-registration.css" rel="stylesheet"
	type="text/css">
...
<script>
	// 회원가입 화면의 입력값들을 검사한다.
	function checkValue() {
		var form = document.guideRegisterForm;

		if (!form.second_lang.value) {
			alert("가능한 제2 외국어를 설정해 주세요")
			return false;
		}

		if (!form.stay_duration.value) {
			alert("가이드 국가의 거주 기간을 입력해 주세요")
			return false;
		}
	}
</script>
...
<body>
	...
	<!-- Page Header -->
	<header class="masthead header-block"
		id="guide-registration-header-img">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8 col-md-10 mx-auto">
				...
				<form name="guideRegisterForm" id="guideRegisterForm"
					name="guideRegisterForm" action="guideRegisterCheck" novalidate=""
					...
					<div class="control-group">
						...
						<input type="text" class="form-control"
							placeholder="가능한 제2 외국어를 설정해 주세요" id="second_lang"
							name="second_lang" required
							data-validation-required-message="Please enter your Second Language.">
					...
					<div class="control-group">
						...
						<input type="text" class="form-control"
							placeholder="가이드 국가의 거주 기간을 입력해 주세요" id="stay_duration"
							name="stay_duration" required
							data-validatio65n-required-message="Please enter your Second Language.">
						<p class="help-block text-danger"></p>
					</div>

					<div class="control-group">
						<h5 class=text-info>INTRODUCTION</h5>
						<input type="text" class="form-control"
							placeholder="자기 소개를 입력해 주세요" id="introduction"
